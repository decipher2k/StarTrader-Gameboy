...
void main(void) {
    ...
    music_load(BANK(song1), &song1), music_pause(music_paused = FALSE);
    //music_play_sfx(BANK(wave_icq_message), wave_icq_message, SFX_MUTE_MASK(wave_icq_message), MUSIC_SFX_PRIORITY_NORMAL);
